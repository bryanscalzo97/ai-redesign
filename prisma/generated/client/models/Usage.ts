...
export type UsageWhereInput = {
  ...
  entitlement?: Prisma.StringFilter<"Usage"> | string
  periodStart?: Prisma.DateTimeFilter<"Usage"> | Date | string
  periodEnd?: Prisma.DateTimeFilter<"Usage"> | Date | string
  count?: Prisma.IntFilter<"Usage"> | number
  limit?: Prisma.IntFilter<"Usage"> | number
  revenuecatUserId?: Prisma.StringFilter<"Usage"> | string
}
...
export type UsageOrderByWithRelationInput = {
  ...
  revenuecatUserId?: Prisma.SortOrder
}

export type UsageWhereUniqueInput = Prisma.AtLeast<{
  userId_entitlement_periodStart?: Prisma.UsageUserIdEntitlementPeriodStartCompoundUniqueInput
  AND?: Prisma.UsageWhereInput | Prisma.UsageWhereInput[]
  OR?: Prisma.UsageWhereInput[]
  NOT?: Prisma.UsageWhereInput | Prisma.UsageWhereInput[]
  userId?: Prisma.StringFilter<"Usage"> | string
...
export type UsageScalarWhereWithAggregatesInput = {
  ...
  entitlement?: Prisma.StringWithAggregatesFilter<"Usage"> | string
  ...
  count?: Prisma.IntWithAggregatesFilter<"Usage"> | number
  limit?: Prisma.IntWithAggregatesFilter<"Usage"> | number
  revenuecatUserId?: Prisma.StringWithAggregatesFilter<"Usage"> | string
}
...
export type UsageUpdateInput = {
  ...
  entitlement?: Prisma.StringFieldUpdateOperationsInput | string
  ...
  revenuecatUserId?: Prisma.StringFieldUpdateOperationsInput | string
}
...
export type UsageUserIdEntitlementPeriodStartCompoundUniqueInput = {
  userId: string
  entitlement: string
  periodStart: Date | string
}
...
export type UsageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "entitlement" | "periodStart" | "periodEnd" | "count" | "limit" | "revenuecatUserId", ExtArgs["result"]["usage"]>
...
export interface UsageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const usageWithUserIdOnly = await prisma.usage.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Usages and only return the `userId`
   * const usageWithUserIdOnly = await prisma.usage.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Usages and only return the `userId`
   * const usageWithUserIdOnly = await prisma.usage.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface UsageFieldRefs {
  ...
  readonly entitlement: Prisma.FieldRef<"Usage", 'String'>
  readonly periodStart: Prisma.FieldRef<"Usage", 'DateTime'>
  readonly periodEnd: Prisma.FieldRef<"Usage", 'DateTime'>
  readonly count: Prisma.FieldRef<"Usage", 'Int'>
  readonly limit: Prisma.FieldRef<"Usage", 'Int'>
  readonly revenuecatUserId: Prisma.FieldRef<"Usage", 'String'>
}
